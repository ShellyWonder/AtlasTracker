...
namespace AtlasTracker.Data.Migrations
{
    ...
    [Migration("20220302173228_ProjectName_003")]
    partial class ProjectName_003
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtlasTracker.Models.BTUser", b =>
                {
            ...
            modelBuilder.Entity("AtlasTracker.Models.Project", b =>
                {
                    ...
                    b.Property<DateTime>("EndDateOffset")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime>("StartDateOffset")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("AtlasTracker.Models.Invite", b =>
                {
                    ...
                    b.HasOne("AtlasTracker.Models.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("AtlasTracker.Models.Notification", b =>
                {
                    ...
                    b.HasOne("AtlasTracker.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId");

                    b.HasOne("AtlasTracker.Models.BTUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.Ticket", "Ticket")
            ...
            modelBuilder.Entity("AtlasTracker.Models.Ticket", b =>
                {
                    b.HasOne("AtlasTracker.Models.BTUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("AtlasTracker.Models.BTUser", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AtlasTracker.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("AtlasTracker.Models.BTUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BTUserProject", b =>
                {
                    b.HasOne("AtlasTracker.Models.BTUser", null)
                        .WithMany()
